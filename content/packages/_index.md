+++
title = "Packages"
description = "Distribusi resmi biner rilis mandiri (standalone static binaries) untuk kakas orkestrasi dan tata kelola platform enterprise."
cascade = { showDate = false, showAuthor = false }
+++

{{< lead >}}
**Pusat Distribusi Biner Resmi (Official Standalone Releases)**

Unduh biner rilis resmi untuk kakas operator infrastruktur dan platform engineering. Seluruh biner dikompilasi secara statis (`CGO_ENABLED=0`) dengan dependensi runtime nol (*zero external dependencies*) dan siap dijalankan secara portabel pada lingkungan Linux dan Windows Server.
{{< /lead >}}

---

## 📦 `tcctl` — Universal Operator CLI for Apache Tomcat Enterprise

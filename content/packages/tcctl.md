...
license = "Apache 2.0"
weight = 1
summary = "Kakas operator statis tunggal untuk tata kelola siklus hidup kontainer, CIS hardening, manajemen TLS PKCS#12 & PEM, host bind-mount (conf:ro), dan orkestrasi GitOps otonom di Linux & Windows Server."
